...
import FacialDataHistory from "../facial-recognition/FacialDataHistory";
      ...
      <div className="space-y-2">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="history" disabled={!patientId}>
              History
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="capture" className="space-y-4">
            ...
            <FaceCapture mode="register" patientId={patientId} onCapture={onCapture} />
          ...
          <TabsContent value="history">
            {patientId && <FacialDataHistory patientId={patientId} />}
          </TabsContent>
        </Tabs>
      </div>
    </div>
