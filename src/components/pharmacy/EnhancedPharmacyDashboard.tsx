            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-3xl font-bold">{medicationOrders.filter(o => o.status === 'active').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200 dark:from-emerald-950 dark:to-emerald-900 dark:border-emerald-800">
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-muted-foreground">Administered Today</p>
                  <p className="text-3xl font-bold">{medicationOrders.filter(o => o.status === 'administered').length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-3xl font-bold">{medicationOrders.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-3xl font-bold">{new Set(medicationOrders.filter(o => o.status === 'active').map(o => o.patient_id)).size}</p>
                </div>
              </div>
            </CardContent>
          </Card>
